...
const Ventas = () => {
  ...
  const normalizePeriodoKey = (periodo, filter) => {
    ...
    switch (filter) {
      case 'dia':
        // periodo es la hora (ej: 14)
        return `${new Date().getFullYear()}-${new Date().getMonth()}-${new Date().getDate()}-${periodo}`;
      case 'semana':
      case 'mes':
  ...
  return (
    <div classsName="ventas-wrapper">
        <div className="ventas-container">
         ...
         <div className="back-to-dashboard5">
